...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"addCode.js":[function(require,module,exports) {
"use strict";
...
var addBlog = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, title, description, content) {
    var res;
  ...
  return function addBlog(_x, _x2, _x3, _x4, _x5) {
...
var _addCode = require("./addCode.js");

var _login = require("./login");

var _signup = require("./signup");

var codeForm = document.querySelector('.form-add-blog');
...
if (codeForm) {
  codeForm.addEventListener('submit', function (e) {
    ...
    (0, _addCode.addBlog)(name, email, title, description, content);
  });
}
